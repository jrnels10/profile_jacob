$(document).ready(function () {
    ...
    function slogan(value) {
        setTimeout(function () {
            $('.white-text').fadeIn(3000);
            $('.intro-links').fadeIn(5000);
        }, value);
    }
    slogan(2000);

    let linkedIn = $(`<div class="row linky m-0"><svg
    ...
    let gitHub = $(`<div class="row gitty m-0"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    width="212px" height="212px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
<g>
...
<g>
    ...
    let projectPort = [
        mapUp = {
            ...
            image: 'assets/images/mapup.jpeg',
            label: 'Map-Up',
    ...
    function loadCarousel() {
        ...
        for (i = 0; i < projectPort.length; i++) {
            ...
            box = $(`
            <div class="col-lg-4 col-md-6 proj-cont position-relative" id="${projectPort[i].num}">

                <div class="view z-depth-1-half h-100" id="images">
                <img src="${projectPort[i].image}" class="img-fluid">
                <h4 class="centered my-4 font-weight-bold">${projectPort[i].label}</h4>
